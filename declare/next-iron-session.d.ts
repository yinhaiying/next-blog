...
declare export type Handler = (req: any, res: any) => any;
...
declare export type CookieOptions = {
...
declare export function applySession(
  req: any,
  res: any,
  sessionOptions: SessionOptions,
): Promise<void>;

declare export function ironSession(
  sessionOptions: SessionOptions,
): (req: any, res: any, next: any) => void;

declare export function withIronSession(
  handler: Handler,
  sessionOptions: SessionOptions,
